...
export default function furtherAreas() {
  return (
    <div>
      <hr className="split-section"></hr>
        <section id="further-areas">
          <div className="container">
            <div className="row">
              <div className="col-12 text-center">
                <div className="content-title-section">
                  <h3 className="title-section">DEMAIS ÀREAS DE ATUAÇÃO</h3>
                  <div className="hr-line-title"></div>
                  <h4 className="subtitle">Locação de Equipamento de Terraplanagem</h4>
                </div>
              </div>
            </div>
            <div className="row">
                ...
                <div className="three-itens">
                  ...
                  <div className="itens-card">
                    <div className="content-title">
                      <img src={Img_icon_tractor.src} className="img-item-icon"/>
                      <h2 className="title">Terraplanagem</h2>
                    </div>
                    <div className="content-itens">
                      <div className="itens">
                        <img src={Img_icon_checked.src} className="icon-check" />
